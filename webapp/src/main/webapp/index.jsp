...
Select the Nick name for DEVOPS: <input type="radio" name="NN"> Chinni<input type="radio" name="NN"> Chotu <input type="radio" name="NN"> Barre<input type="radio" name="NN"> Pagal <input type="radio" name="NN">Bangaram<input type="radio" name="NN"> Paa <input type="radio" name="NN">Chinnamma<input type="radio" name="NN"> other<input type="text" placeholder=> <br><br>
